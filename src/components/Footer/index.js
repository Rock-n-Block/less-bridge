    ...
    <footer className="footer">
      ...
      <div className="footer-links">
        <div className="footer-copyright">
          2021 © LessBridge product of Less Network — less.xyz
        </div>
        <div className="footer-social">
          <a target="_blank" href={config.links.twitter} rel="noreferrer">
            <Twitter />
          </a>
          <a target="_blank" href={config.links.medium} rel="noreferrer">
            <Medium />
          </a>
          <a target="_blank" href={config.links.telegram} rel="noreferrer">
            <Telegram />
          </a>
          <a target="_blank" href={config.links.github} rel="noreferrer">
            <Github />
          </a>
        </div>
      </div>
