...
export default class AvalancheService {
  constructor({ networkFrom, contractDetails }) {
    console.log('AvalancheService', contractDetails);
    this.name = 'avalanche';
    ...
    this.wallet &&
      this.wallet.on('chainChanged', (newChain) => {
        localStorage.setItem('walletTypeOnReload', 'avalanche');
    ...
    this.wallet &&
      this.wallet.on('message', (message) => {
        console.log('avalanche message', message);
      });
  ...
  async getAccount() {
    ...
    return new Promise((resolve, reject) => {
      ...
      const messagePleaseChooseNet = () =>
        reject({
          errorMsg: `Please choose ${neededNetName} network in your avalanche wallet`,
        });
      const getAccounts = () =>
        this.wallet
