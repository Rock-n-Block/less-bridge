...
export default class FantomService {
  constructor({ networkFrom, contractDetails }) {
    console.log('FantomService', contractDetails);
    this.name = 'fantom';
    ...
    this.wallet &&
      this.wallet.on('chainChanged', (newChain) => {
        localStorage.setItem('walletTypeOnReload', 'fantom');
    ...
    this.wallet &&
      this.wallet.on('message', (message) => {
        console.log('fantom message', message);
      });
  ...
  async getAccount() {
    ...
    return new Promise((resolve, reject) => {
      ...
      const messagePleaseChooseNet = () =>
        reject({
          errorMsg: `Please choose ${neededNetName} network in your fantom wallet`,
        });
      const getAccounts = () =>
        this.wallet
